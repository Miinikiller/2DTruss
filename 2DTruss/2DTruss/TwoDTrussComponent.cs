...
namespace _2DTruss
{
    public class TwoDTrussComponent : GH_Component
    {

        public TwoDTrussComponent()
          : base("2DTrussCalculation", "2DTrussC",
              "2D Truss Deformations and Forces Calculation",
              "Koala", "2D Truss")
        {
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Resources.Image1;    //Setting component icon
            }
        }
        public override Guid ComponentGuid
        {
            get { return new Guid("a50c0c97-e3fe-471f-a5e1-98efe9f0f366"); }
        }
    }
}
